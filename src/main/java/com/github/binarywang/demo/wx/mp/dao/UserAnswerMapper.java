...
public interface UserAnswerMapper {
    ...
    @Insert("INSERT INTO t_user_answer(wechatUserId, questionId, userAnswerIndex, updateTime) VALUES( #{wechatUserId}, #{questionId}, #{userAnswerIndex}, #{updateTime} )")
    ...
    @Select("SELECT * FROM t_user_answer WHERE userAnswerIndex = #{userAnswerIndex}")
    List<UserAnswer> findByUserAnswerIndex(@Param("userAnswerIndex") int userAnswerIndex);

    @Select("SELECT * FROM t_user_answer WHERE questionId = #{questionId}")
